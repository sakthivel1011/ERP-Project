...
export default function Quotations() {
  ...
  const quotationData = liveData?.quotations;
  ...
  }, [quotationData, statusfilter, liveData]);
  ...
  const kpiData = useMemo(() => {
    const quotationList = liveData?.quotations || [];
                    ...
                    <Controller
                      ...
                      render={({ field: rateField }) => (
                        <TextField
                          ...
                          fullWidth
                          onChange={(e) =>
                            rateField.onChange(Number(e.target.value))
                          }
                        />
                      )}
                    />
                    ...
                    <Controller
                      ...
                      render={({ field: gstField }) => (
                        <TextField
                          ...
                          fullWidth
                          onChange={(e) =>
                            gstField.onChange(Number(e.target.value))
                          }
                        />
                      )}
                    />
              ...
              selectedQuotation.rawQuotation?.items?.map((items, index) => (
                ...
                >
                  ...
                  <Stack spacing={0.5} sx={{ mt: 1 }}>
                    ...
                    >
                      Line Amount: ₹{items.amount?.toLocaleString("en-IN") || 0}
                    </Typography>
                  </Stack>
                </Box>
              ))
  ...
  return (
    ...
    >
      <Typography
        variant="h5"
        className="heading"
        sx={{ mb: 1, color: "black", textAlign: "left", mt: -1 }}
      >
      ...
      <Box
        className="filter"
        sx={{ display: "flex", justifyContent: "flex-end", gap: 2, mt: 0 }}
      >
        <TextField
          select
          variant="outlined"
